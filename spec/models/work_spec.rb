  ...
  describe "to_builder" do
    it "has valid to_builder - v1" do
      ...
      expect(json).to match(
        ...
        'wks_ecco_corrected_xml_path' => work.wks_ecco_corrected_xml_path,
        'wks_ecco_corrected_text_path' => work.wks_ecco_corrected_text_path,
